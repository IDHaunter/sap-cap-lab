...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("AuthorsListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheAuthorsListGenerated.iSeeThisPage();
        });

        opaTest("Check filter bar", function (Given, When, Then) {
            Then.onTheAuthorsListGenerated.onFilterBar().iCheckFilterField({ property: "name" });
        });
        ...
        //     When.onTheAuthorsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheAuthorsListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheAuthorsListGenerated.onTable(defaultTableId).iCheckRows();
        // });

        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onTheAuthorsListGenerated.onTable(defaultTableId).iCheckColumns(undefined, {"name":{"header":"Name"}});
        });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheAuthorsListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheAuthorsListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheAuthorsListGenerated.onTable(defaultTableId).iPressRow(0);
