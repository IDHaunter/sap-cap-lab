...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check body sections of the Object Page", function (Given, When, Then) {
            Then.onTheBooksObjectPageGenerated.iCheckSection({ section: "FieldGroup::Details" });
            Then.onTheBooksObjectPageGenerated.onForm({ section: "FieldGroup::Details" }).iCheckField({ property: "title" });
            Then.onTheBooksObjectPageGenerated.onForm({ section: "FieldGroup::Details" }).iCheckField({ property: "stock" });
            Then.onTheBooksObjectPageGenerated.onForm({ section: "FieldGroup::Details" }).iCheckField({ property: "author_ID" });
       });
